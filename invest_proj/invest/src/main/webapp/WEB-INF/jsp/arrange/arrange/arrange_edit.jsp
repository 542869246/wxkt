		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="arrange/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ARRANGE_ID" id="ARRANGE_ID" value="${pd.ARRANGE_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="ARRANGE_NAME" id="ARRANGE_NAME" value="${pd.ARRANGE_NAME}" maxlength="32" placeholder="这里输入课程名" title="课程名" style="width:98%;"/></td>
							</tr>
							<tr>
