				...
				<div class="row">
					...
					<form action="webschedule/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;" class="bitianxiang">学生:</td>
								<td ><input type="text" value="${pd.stuName.STUDENT_NAME}" maxlength="32" readonly="readonly" placeholder="" title="学生" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function changecourse(c){
			...
			$.ajax({
				url:'<%=basePath%>courses_subject/stats.do',
				data:{"COURSES_ID":c},
				type:"POST",
				success:function(data){
					if(data==0){
