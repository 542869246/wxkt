...
<script type="text/javascript"
	src="http://api.map.baidu.com/api?v=2.0&ak=T6sS8po1CHrmlYL7o81m4SFXGIZkdffz"></script>
	...
	<div>
		<table bgcolor="#E3E4D8" width="100%">
			<tr>
				...
				<td width="100"><input type="text" id="suggestId1" size="20"
					value="这里输入搜索地址1" style="width: 150px;" />
					</div>
					<div id="searchResultPanel1"
						style="border: 1px solid #C0C0C0; width: 150px; height: auto;">
						<input type="text" id="suggestId2" size="20" value="这里输入搜索地址2"
							style="width: 150px;" />
					</div>
...
<script type="text/javascript">
	...
	function setPlace(myValue) {
		...
		function myFun() {
			...
			//console.log(local.getResults().getPoi(0),local.getResults().getPoi(1))
