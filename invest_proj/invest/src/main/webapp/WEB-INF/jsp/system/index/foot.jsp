		...
		<script src="static/ace/js/bootstrap.js"></script>
				<script>
				$(function(){
					var classList=$(".bitianxiang");
					$(".bitianxiang").each(function(){
						var bitianxiang =$(this).text();
						bitianxiang="<span style='color:red'>*</span>&nbsp"+bitianxiang;
						$(this).html(bitianxiang); 
					})
				});
				</script>