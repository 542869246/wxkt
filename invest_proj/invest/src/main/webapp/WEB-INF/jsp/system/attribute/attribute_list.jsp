							...
							<td style="vertical-align:top;padding-left:2px;">
								 	<div class="nav-search">
										<span class="input-icon"><strong>类型:</strong>
											<input id="citySel" type="text" placeholder="点击选择类型" readonly="readonly"  class="nav-search-input"  autocomplete="off" name="attrType"  value="${pd.attrType}"   onclick="showMenu();"/>
