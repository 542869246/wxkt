						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<c:if test="${fx != 'head'}">
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;" class="bitianxiang">角色:</td>
											<td id="juese">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;" class="bitianxiang">用户名:</td>
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;" class="bitianxiang">编号:</td>
	...
	<c:if test="${pd.USER_ID!=null}">
		<div
			...
			<button class="mytab active"
				onclick="javascript:mytab.active(this,mytab.userSubjects);">老师的科目</button>
			<button class="mytab" 
			onclick="mytab.active(this,mytab.usercourses);">老师的课程</button>
		</div>
...
<script type="text/javascript">
	...
	var mytab = {
			userSubjects:"<%=basePath%>subject_teacher/list.do?TEACHER_ID=${pd.USER_ID}",
			usercourses:"<%=basePath%>courses_teacher/list.do?USER_ID=${pd.USER_ID}",
