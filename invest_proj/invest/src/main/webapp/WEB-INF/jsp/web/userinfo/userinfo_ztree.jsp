...
<body>
	...
	<table style="width: 100%;" border="0">
		<tr>
			...
			<td style="width: 85%;" valign="top"><iframe name="treeFrame" 	
					...
					src="<%=basePath%>/userinfo/list.do?DICTIONARIES_ID=${'' == DICTIONARIES_ID?'0':DICTIONARIES_ID}&currentPage=${null == pd.dnowPage || '' == pd.dnowPage?'1':pd.dnowPage}"
	...
	<script type="text/javascript">
		...
		$("#leftTree li a[href='userinfo/list.do?USER_GROUPID= &groupType=690745a213774651a563f127c6c1ebd9']").parents("li").siblings().hide();			
		});
