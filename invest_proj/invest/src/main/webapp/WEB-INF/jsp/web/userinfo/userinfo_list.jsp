				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- 检索  -->
							<form action="userinfo/list.do" method="post" name="Form"
								id="Form">
										...
										<td>
											<div class="nav-search">
												<span class="input-icon"> <input type="text"
													placeholder="姓名" class="nav-search-input"
												...
												<c:if test="${QX.cha == 1 }">
													<c:forEach items="${varList}" var="var" varStatus="vs">
														<tr>
															...
															<td class='center' hidden="hidden">${var.USER_OPPNID}</td>
															<td class='center'>
																<c:choose>
																	<c:when test="${var.USER_ATTESTATION == 1}">
																		<span>已认证</span>
																	</c:when>
																	<c:otherwise>
