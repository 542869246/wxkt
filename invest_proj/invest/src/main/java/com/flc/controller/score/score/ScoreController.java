package com.flc.controller.score.score;
...
import com.flc.service.score.score.ScoreManager;
...
public class ScoreController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("SCORE_ID", this.get32UUID());	//主键
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("SCORE_ID"));	    //1
			vpd.put("var2", varOList.get(i).getString("SCORE_GIFTNAME"));	    //2
			vpd.put("var3", varOList.get(i).getString("SCORE_EXCTIME"));	    //3
			vpd.put("var4", varOList.get(i).get("SCORE_EXPENDS").toString());	//4
			vpd.put("var5", varOList.get(i).getString("STUDENT_ID"));	    //5
