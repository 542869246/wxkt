package com.flc.controller.system.message;
...
import com.flc.service.system.message.MessageManager;
...
public class MessageController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("SERVER_TITLE"));	    //1
			vpd.put("var2", varOList.get(i).getString("SERVER_CONTENT"));	    //2
			vpd.put("var3", varOList.get(i).getString("SERVER_CREATETIME"));	    //3
			vpd.put("var4", varOList.get(i).getString("SERVER_CREATEBY"));	    //4
			varList.add(vpd);
		}
