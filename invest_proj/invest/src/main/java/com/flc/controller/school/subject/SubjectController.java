package com.flc.controller.school.subject;
...
public class SubjectController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("school/subject/subject_list");
	...
	@ResponseBody
	public PageData findSubject() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		 PageData count = subjectService.count(pd);
		pd.put("count", count.get("COUNT(1)"));
		return pd;
	}
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("school/subject/subject_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("SUBJECT_NAME"));	    //2
			vpd.put("var3", varOList.get(i).getString("MODIFYBY"));	    //3
			vpd.put("var4", varOList.get(i).getString("MODIFYDATE"));	    //4
