package com.flc.service.school.classroom.impl;
...
public class ClassroomService implements ClassroomManager{
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("ClassroomMapper.delete", pd);
	}
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("ClassroomMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("ClassroomMapper.listAll", pd);
	}
	...
	public List<PageData> listByTime(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("ClassroomMapper.listByTime", pd);
	}
}
