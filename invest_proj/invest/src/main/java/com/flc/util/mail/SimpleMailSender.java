...
/**   
  ...
  */    
    public boolean sendTextMail(MailSenderInfo mailInfo) throws Exception{    
      ...
      pro.put("mail.smtp.starttls.enable","true");//使用 STARTTLS安全连接  
//    //props.put("mail.smtp.port", "25");             //google使用465或587端口  
    ...
    public  boolean sendHtmlMail(MailSenderInfo mailInfo) throws Exception{    
      ...
      pro.put("mail.smtp.starttls.enable","true");//使用 STARTTLS安全连接  
//    //props.put("mail.smtp.port", "25");             //google使用465或587端口  
      pro.put("mail.smtp.auth", "true");        // 使用验证 
    ...
    public static void main(String[] args){   
	  ...
	  /*   try {
				sendEmail("smtp.qq.com", "25", "1256475121@qq.com", "iasyhvzqhzwggdai", "466465433@qq.com", "测试邮件", "测试OK","2");
			} catch (Exception e) {
				System.out.println("baocuo3");
				e.printStackTrace();
			}*/
	     try {
			sendEmail("smtp.163.com", "25", "li1292833534@163.com", "li1292833534", "1256475121@qq.com", "测试邮件", "测试OK","2");
		} catch (Exception e) {
			System.out.println("baocuo2");
			e.printStackTrace();
		}
	     //发送短信
		...
		String accessKeySecret = null;
			signName = "学鹿教育";
			tecode = "SMS_116590646";
			accessKeyId = "LTAIVbVyzUQbMYCT";
			accessKeySecret = "i9Sx7dRPMheIQPjRpOB8jJvLBQNW3K";
		Random r = new Random();
		String str = "nihao";
		for (int i = 0; i < 4; i++) {
			str += r.nextInt(10);
		...
		try {
			response =aLiYunSmsUtil.sendSms("15935831718", signName, tecode, teparam, accessKeyId, accessKeySecret);
	     ...
	     try {
				sendEmail("smtp.qq.com", "25", "466465433@qq.com", "ssbkybtsmqphbiag", "1256475121@qq.com", "测试邮件", "测试OK","2");
			} catch (Exception e) {
				System.out.println("baocuo1");
				e.printStackTrace();
			}
	     //这个类主要来发送邮件   
	     //SimpleMailSender sms = new SimpleMailSender();   
