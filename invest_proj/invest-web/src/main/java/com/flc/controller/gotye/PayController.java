...
import com.flc.entity.gotye.SendMsgReq;
...
@Controller
 public class PayController {
	 ...
	 private String apiUrl = "https://livevip.com.cn/liveApi";
	   ...
	   static {
		   //初始化beecloud
		   BeeCloud.registerApp(GotyeConfig.getBeeCloudAppId(),GotyeConfig.getBeeCloudTestSecret(),GotyeConfig.getBeeCloudAppSecret(),GotyeConfig.getBeeCloudMasterSecret());
 		   if(GotyeConfig.getBeeCloudSandbox()!=null&&GotyeConfig.getBeeCloudSandbox().equals("true")){
			   //测试模式
	   ...
	   public void payOver(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		public @ResponseBody Map<String, Object> wxjsapipay(@PathVariable Long roomId,HttpServletRequest req, HttpServletResponse resp, ModelMap map) throws Exception {
			...
			String token = GotyeCookiesUtil.getCookie(req, "room_token_"+roomId);
			...
			String openId = GotyeCookiesUtil.getCookie(req, "weChatOpenId");
