package com.flc.service.web.comment.impl;
...
public class CommentService implements CommentManager{
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PageData> findCommentByNewsId(Page page) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("findCommentByNewsId", page);
	}
