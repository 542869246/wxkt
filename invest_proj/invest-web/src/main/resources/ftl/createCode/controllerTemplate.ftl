package com.flc.controller.${packageName}.${objectNameLower};
...
import com.flc.service.${packageName}.${objectNameLower}.${objectName}Manager;
 ...
 */
@Controller
@Api(value = "${objectName}Controller",tags="${TITLE}")
...
<#list fieldList as var>
	 ...
	 * @throws Exception
	 */
	  @ApiOperation(value = "去新增页面", notes = "去新增页面")
	 ...
	 * @throws Exception
	 */
	  @ApiOperation(value = "去修改页面", notes = "去修改页面")
