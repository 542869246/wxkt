<%@ page import="com.weixin.WxConfig" %>
...
// 		alert("jump:"+jump);
		...
		var src = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=<%=WxConfig.APPID%>&redirect_uri="+urlencode(_j_url)+"&response_type=code&scope=snsapi_userinfo&state="+STATE+"#wechat_redirect";
	...
	$(function(){
		...
		if(null==m||undefined==m){
			...
			if(!(document.cookie || navigator.cookieEnabled)){
				layer.open({type:0,title:'提示',content:'cookie被禁用，请将该权限放开！',end:function(){
...
<style type="text/css">
.FENBOT-CHATBTN-ROUND{display: none;}
</style>