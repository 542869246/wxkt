...
<html>
    <head>
        ...
        <link href="${basePath}static/wx/img/ico.png" rel="shortcut icon">
        <link href="${basePath}static/css/style.css" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="${basePath}static/css/reset.css">
        <script src="${basePath}static/wx/js/jquery-1.8.3.min.js"></script>
        <script type="text/javascript">
        	var basePath=<%=basePath%>;
        </script>
    	<!-- 模板 -->
    	<script src="${basePath}static/wx/js/ejs.js"></script>
    	<!-- 表情 -->
    	<script src="${basePath}static/wx/js/expression.js"></script>
    	<script src="${basePath}static/wx/js/util.js"></script>
    	<!-- 页面初始化 -->
    	<script src="${basePath}static/wx/js/winInit.js"></script>
    	<!-- h5监听手势滑动等事件 -->
    	<script src="${basePath}static/wx/js/hammer.min.js"></script>
    	
    	<!-- 聊天模块 -->
    	<script src="${basePath}static/wx/js/model/chat.js"></script>
    	<!-- 课件模块  -->
    	<script src="${basePath}static/wx/js/model/courseware.js"></script>
    	<!-- 视频模块 -->
    	<script src="${basePath}static/wx/js/model/play.js"></script>
    	<!-- 亲加视频直播js库 -->
    ...
    <body>
       ...
       <div id="topPopover" class="mui-popover" style='width:150px;'>
  		<ul class="mui-table-view">
    		...
    		<li class="mui-table-view-cell"><span class='view_classname'>教室2</span><span class='view_classid' style='display: none'>2</span></li>
    		<li class="mui-table-view-cell"><span class='view_classname'>教室3</span><span class='view_classid' style='display: none'>3</span></li>
    		<li class="mui-table-view-cell"><span class='view_classname'>教室4</span><span class='view_classid' style='display: none'>4</span></li>
    		<li class="mui-table-view-cell"><span class='view_classname'>教室5</span><span class='view_classid' style='display: none'>5</span></li> -->
  		</ul>
	  </div>
            ...
            <div class="header" style='position: relative;'>
                ...
                <!-- 下拉 -->
                <div class='zyf_header'>
              		选择教室&nbsp;&nbsp;<a id="menu" class="mui-action-menu mui-icon mui-icon-bars mui-pull-right" style="color:#8f8f94;margin-right:12px" href="#topPopover"></a>
				</div>
            ...
            <div class="chat-plate" id="">
                <div class="tabs" id="activity_tab">
                	 <ul class="display-box fastclick" >_
					 ...
					 <li class="flex" data-tab="infor-tab52"> 
				   		<a href="javascript:void(0);">直播介绍</a>
					 </li>
					</ul>
                </div>
                      ...
                      <div class="swiper-wrapper" id="content1" >
						 ...
						 <section class="swiper-slide docbox" id="infor-tab81">
						 	<div class="default-kj">
						 		...
						 		<p id="kjp" style=""><img src="${basePath}static/wx/img/kj.png"></p>
						 	</div>
                              ...
                              <div id="giftBox" style="display:none;">
                        		...
                        		<div class="page_emotion box_swipe" id="page_emotion">
                           			 ...
                           			 <div style="vertical-align: top; float: left; width: 375px;">
                           			   	<dd data-name="小花" data-price='0' data-src="${basePath}static/wx/img/gift/gift_5.png">
											<img src="${basePath}static/wx/img/gift/gift_5.png"><span class="diamond"><i></i>免费</span>
									 	</dd>
                           			    <dd data-name="摩托车" data-price='0' data-src="${basePath}static/wx/img/gift/gift_4.png">
											<img src="${basePath}static/wx/img/gift/gift_4.png"><span class="diamond"><i></i>免费</span>
									 	</dd>
                           			    <dd data-name="手捧花" data-price='0' data-src="${basePath}static/wx/img/gift/gift_3.png">
											<img src="${basePath}static/wx/img/gift/gift_3.png"><span class="diamond"><i></i>免费</span>
									 	</dd>
                           			 	<dd data-name="砖石" data-price='0' data-src="${basePath}static/wx/img/gift/gift_2.png">
											<img src="${basePath}static/wx/img/gift/gift_2.png"><span class="diamond"><i></i>免费</span>
									 	</dd>
                           			   	<%--  收费礼物需要微信登陆模式才能支付
                           			   	<dd data-name="跑车" data-price='0.01' data-src="${basePath}static/wx/img/gift/gift_1.png">
											<img src="${basePath}static/wx/img/gift/gift_1.png"><span class="diamond"><i></i>0.01</span>
									 	</dd> --%>
									</div>
                             		</dl><!-- 礼物框 -->
                             		<dt>
                            ...
                            <ul class="ulList2">
                                <li>
                                    <a href="javascript:void(0);" id="weChatLoginBtn">
                                        <img src="${basePath}static/wx/img/weixin.png">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" id="qqLoginBtn">
                                        <img src="${basePath}static/wx/img/qq.png">
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <script type="tmpl" id="temp_text_enter_event">
				<li class="system_msg">
                      <a class="leftHead" href="javascript:void(0);"><img src="${basePath}static/wx/img/system_img.png"></a>
                      <div class="leftChat">
                      <i></i>
		...
		<script type="tmpl" id="temp_text_notify">
			...
			<script type="tmpl" id="temp_text_msg">
				...
				<&}&>
                    <a class="leftHead" href="javascript:void(0);"><&if(data.headUrl){&><img src="<&=data.headUrl&>"/><&}else{&><img src="${basePath}static/wx/img/hd_img.png" /><&}&></a>
                          <div class="leftChat">
                              <i></i>
                              <p>
       ...
       $(function(){
        <c:if test="${roomId==null}">
			...
			for(var i=0;i<roomList.length;i++){
				if(roomList[i].CHECKTYPE==0){
					falg=false;
					loadGotye(roomList[i].CLASSROOM_ROOMID);
		        	break;
		        }
			}
			if(falg){
				//alert(roomList[0])
				loadTencent(roomList[0].CLASSROOM_ID);//腾讯
			}
        </c:if>
    	 <c:if test="${roomId!=null}">
    	// alert("${wxJsApiAppId}")
    	tokenKey=Tool.getCookie("${tokenKey}");
    	roomId=${room}.roomId;
    	room=${room};
    	wxJsApiAppId="${wxJsApiAppId}";
  	  	loadSuccess(tokenKey,wxJsApiAppId,room,roomList);
  	  	</c:if>
       });
       //加载视频函数
       function loadSuccess(tokenkey,wxJsApiAppId,room,roomList){
	    		...
	    		if(room){
	   				...
	   				var roomClassId;
	   				for(var i=0;i<roomList.length;i++){
	   					if(room.roomId==roomList[i].CLASSROOM_ROOMID){
	   						starttime=roomList[i].starttime;
	   						endtime=roomList[i].endtime;
	   						whether=roomList[i].whether;//是否是临时
	   						roomClassId=roomList[i].CLASSROOM_ID;
	   					}
	   				}
	        		...
	        		if(whether==0){
	        			passwordva(roomClassId,0);//是亲加
	        		}
	        		Chat = new Gotye.Chat(tokenkey);//聊天
	   				$("#anchorIntr").html(room.anchorDesc);//主播介绍
	   				loadPlayer(tokenkey);//加载视频
	   				loadCourseware();//加载课件
	    		}else{
